...
def load_documents():
    ...
    pdf_path = "/home/konstantinos/sodapdf-converted.pdf"
...
if __name__ == "__main__":
    ...
    # 5. Create RAG Chain
    rag_chain = create_rag_chain(vector_store, llm_model_name=model) # Use the chosen Qwen 3 model

    # 6. Query
    query_question = "Create 5 flashcards for this" # Replace with a specific question
